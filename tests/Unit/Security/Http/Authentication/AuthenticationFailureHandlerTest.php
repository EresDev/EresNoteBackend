<?php
namespace App\Tests\Unit\Security\Http\Authentication;

use App\Security\Http\Authentication\AuthenticationFailureHandler;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Security\Core\Exception\AuthenticationException;
/**
 * AuthenticationFailureHandlerTest.
 *
 * @author EresDev <hi@eresdev.com>
 */
class AuthenticationFailureHandlerTest extends TestCase
{
    ...
    public function testOnAuthenticationFailure()
    {
        ...
        $this->assertEquals('Expected Authentication Message!', $content['message']);
    }
    /**
    ...
    {
        return new AuthenticationException("Expected Authentication Message!");
    }
}